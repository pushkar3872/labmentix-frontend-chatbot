      ...
      <div className="backdrop-blur-lg bg-white/10 border border-white/20 p-10 rounded-3xl shadow-2xl w-full max-w-md relative group hover:bg-white/15 transition-all duration-500">
        ...
        <div className="relative space-y-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-blue-200 text-lg font-light">Sign in to your account</p>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center space-x-2 text-blue-200 cursor-pointer">
              <input 
                type="checkbox" 
                className="w-4 h-4 rounded border-blue-400/30 bg-white/5 text-blue-500 focus:ring-blue-400/50 focus:ring-2"
              />
              <span>Remember me</span>
            </label>
            <a href="#" className="text-red-400 hover:text-red-300 hover:underline transition-colors duration-200">
              Forgot password?
            </a>
          </div>
